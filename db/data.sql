...
INSERT INTO videos (link, title, author, categoryid, duration, ranking) VALUES
    ...
    ('https://www.youtube.com/embed/m5vKQ7ATBNc', 'Je corrige les scripts Ubuntu - Conseils et bonnes pratiques en BASH', 'cocadmin', 6, '00:16:29', 4.88),
    ...
    ('https://www.youtube.com/embed/Fiz3lMZhWKM', 'Bash[#1] - Comprendre ce qui est Bash', 'c0d3r sk1llz', 6, '00:07:08', 5.0),
    ...
    ('https://www.youtube.com/embed/4Q9adopz82E', 'Gnu / Linux : mesurer simplement le temps de éxécution dans un script BASH', 'Christophe Casalegno', 6, '00:09:01', 5.0);
